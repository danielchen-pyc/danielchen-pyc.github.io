...
- [大綱](#introduction)
- [使用說明](#guide)
- [柔軟度 (Flexibility)](#flexibility)
    - [臀部拉筋 (Hip Stretches)](#hip-stretches)
    - [腿部拉筋 (Leg Stretches)](#leg-stretches)
    - [腳踝靈活度 (Ankle Mobility)](#ankle-mobility)
    - [膝蓋靈活度 (Knee Mobility)](#knee-mobility)
- [臀腿](#bottom)
    - [靠牆半蹲 (Wall Sit)](#wall-sit)
    - [深蹲 (Deep Squats)](#deep-squat)
    - [深蹲變化 (Squat Variations)](#deep-squat-variations)
- [平衡力](#balance)
    - [雙腳半球平衡訓練 (Bosu Ball Balance)](#bosu)
    - [深蹲半球平衡訓練 (Bosu Ball Balanced Squat)](#bosu-squat)
    - [單腳半球平衡訓練 (Single-Legged Bosu Ball Balance)](#single-leg-bosu)
- [核心](#core)
    - [捲腹訓練 (Stomach Crunches)](#crunch)
    - [俄羅斯轉體 (Russian Twist)](#russian-twist)
    - [棒式 (Plank)](#plank)
...
- 平時有在運動，自認腿力不錯，做深蹲的時候完全不費力：從[ 深蹲變化 (Squat Variations) ](#deep-squat-variations)開始

<div class="side-by-side-normal">
    <div class="toleft" id="raised-ankle-squating">
        <img class="image" src="/assets/images/snowboarding/butt-wink.png"/>
        <figcaption class="caption">腳踝抬起 Poor Ankle Mobility (<a href="https://www.inspireusafoundation.org/foot-positioning-for-squats/">source</a>)</figcaption>
    </div>
    <div class="toright" id="leaning-forward">
        <img class="image" src="/assets/images/snowboarding/squat-hips-too-high.gif"/>
        <figcaption class="caption">身體前傾 Upper Body Leaning Forward (<a href="https://www.inspireusafoundation.org/knees-caving-in-the-squat/">source</a>)</figcaption>
    </div>
</div>
...
<h2 id="wall-sit"><bold>靠牆半蹲 (Wall Sit) </bold></h2>
...
- **姿勢**：雙腳與肩同寬，腳尖稍微[指向外側](#knee-position)（很重要！），保持背部挺直，不要彎曲或前傾。腳底板三點（大拇指下緣、腳底外側、腳跟）抓住地面，足弓一定要離開地面，才抓得緊地板、膝蓋也不會內凹！
...
<div class="side-by-side-normal">
    ...
    <div class="toright">
        <img class="image" src="/assets/images/snowboarding/squat-incorrect-knees.gif"/>
        <figcaption class="caption">正確膝蓋方向 Correct Squating Knee Position (<a href="https://www.inspireusafoundation.org/are-squats-bad-for-your-knees/">source</a>)</figcaption>
    </div>
</div>
...
<h2 id="bosu-squat"><bold>深蹲半球平衡訓練 (Bosu Ball Balanced Squat)</bold></h2>
...
<h2 id="russian-twist"><bold>俄羅斯轉體 (Russian Twist)</bold></h2>

<h2 id="plank"><bold>棒式 (Plank)</bold></h2>

<h2 id="side-plank"><bold>側邊棒式 (Side Plank)</bold></h2>
